...
<div class="widget"> 
  ...
  <div style="text-align: center;"><h1 href="" style="align:center">Digital and Wireless communication project</h1></div>
  <div class="lower">    
    <ul class="infos">
      <li class="info temp">
...
function drawClock(){
    ...
    xhttp.onreadystatechange = function() {
      ...
      var obj = JSON.parse(txt); //Ref: https://www.w3schools.com/js/js_json_parse.asp
        document.getElementById("rain").innerHTML = 267- obj.Rain + "%";
